...
import 'package:watsonapp/views/tabs_page.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _easyDialog() {
    EasyDialog(
        topImage: AssetImage("assets/images/banner_watson.png"),
        height: 240,
        cornerRadius: 10,
        fogOpacity: 0.6,
        width: 350,
        title: Text(
          "Ayudando en tiempos de crisis",
          style: TextStyle(fontWeight: FontWeight.bold),
          textScaleFactor: 1.2,
        ),
        description: Text(
          "Cory es un asistente virtual desarrollado con el fin de ayudar a la población a solucionar distintas dudas que puedan tener acerca del COVID-19 y apoyarlos en el proceso de enfrentar este virus",
          textScaleFactor: 1.1,
